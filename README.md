# BossMechanicRecorder 插件分发库

卫月（Dalamud）第三方插件仓库，用于安装 **Boss机制录入（BossMechanicRecorder）**：录制 Boss 台词/读条/Zone IPC，导出 TechGuide Boss 序列素材。
...
```
https://raw.githubusercontent.com/sortec001/boss-mechanic-recorder-repo/main/pluginmaster.json
```

3. 打开 **插件安装器**，搜索 **Boss机制录入** 或 **BossMechanicRecorder** 并安装

游戏内命令：`/bmr` 打开录入窗口；`/bmrmini` 打开迷你窗口。
...
| `release/BossMechanicRecorder/latest.zip` | 安装包 |

## 更新

在插件安装器中刷新仓库列表，对 Boss机制录入 执行更新即可。
